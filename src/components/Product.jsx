...
const Product = ({post}) => {
  ...
  return (
    <div className=' group flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in shadow hover:shadow-[0px_0px_95px_53px_#00000024] gap-3 p-4 mt-10 ml-5 rounded-xl'>
        <div ><p className='truncate w-40 mt-1 text-gray-700 font-semibold text-lg  text-left'>{post.title}</p></div>
        ...
        <div className=' text-green-600 font-semibold' ><p>${post.price}</p></div>
